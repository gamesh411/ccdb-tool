...
CCDB_TOOL_DIR = $(BUILD_DIR)/ccdb_tool
...
build:
	python3 setup.py build --build-purelib $(CCDB_TOOL_DIR)

build_in_env: venv_dev
	$(ACTIVATE_DEV_VENV) && python3 setup.py build --build-purelib $(CCDB_TOOL_DIR)
