...
from .clangsa_version import get as clangsa_version_get
from . import gcc_toolchain
from .util import load_json_or_empty
...
def parse_buildaction(entry, **kwargs):
    compiler_info_file = kwargs.get('compiler_info_file', None)
    keep_gcc_include_fixed = kwargs.get('keep_gcc_include_fixed', None)
    keep_gcc_intrin = kwargs.get('keep_gcc_intrin', None)
...
def detect_compiler(compilation_database):
    pass

def parse_build_actions(compilation_database):

    return BuildAction(**details)

def skip_build_actions(compilation_database):
    pass

def unique_build_actions(compilation_database):
    pass
