...
import codechecker_ccdb_tool.log_parser as log_parser
from codechecker_ccdb_tool.util import load_json_or_empty
from .skiplist_handler import SkipListHandler
...
class LogParserTest(unittest.TestCase):
    ...
    def test_skip_everything_from_parse(self):
        ...
        -*/lib2/*
        """
        analysis_skip = SkipListHandler(skip_list)
        pre_analysis_skip = SkipListHandler(skip_list)
    ...
    def test_skip_all_in_pre_from_parse(self):
        ...
        """
        analysis_skip = SkipListHandler(skip_list)
        pre_analysis_skip = SkipListHandler(pre_skip_list)
    ...
    def test_skip_no_pre_from_parse(self):
        ...
        """
        analysis_skip = SkipListHandler(skip_list)
        pre_analysis_skip = SkipListHandler("")
